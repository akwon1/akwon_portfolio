...
```{r}
#already done (K-nearest)
# distance to parks (1,3,5)
# distance to schools (1,3,5)
# distance to transit stops (1,3,5)
# distance to center city

# Missing KNN (landmarks, crashes, crimes, hospitals)


#buffer-based
# number of parks/schools/transit stops within 0.5miles (2640ft)
# crime
# car crashes
# hospitals
# monuments
