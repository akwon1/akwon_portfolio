...
setwd("/Users/angiekwon/Documents/GitHub/akwon_portfolio/inclass_exercise/week4/data")

# Load the data (same as lecture)
pa_counties <- st_read("/Users/angiekwon/Documents/GitHub/akwon_portfolio/inclass_exercise/week4/data/Pennsylvania_County_Boundaries.shp")
districts <- st_read("/Users/angiekwon/Documents/GitHub/akwon_portfolio/inclass_exercise/week4/data/districts.geojson")
hospitals <- st_read("/Users/angiekwon/Documents/GitHub/akwon_portfolio/inclass_exercise/week4/data/hospitals.geojson")
...
# st_overlaps for overlapping polygons
...
Counts itself when doing sf_intersects
---
...
Well served with a 100% within 15 miles of a hospital.
---
...
```{r}
#make pa_counties' projection same as districts
st_crs(pa_counties)
st_crs(districts)
